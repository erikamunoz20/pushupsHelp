...
It appears that the skill players are able to do more pushups rather than the line players that do less pushups.
...
summary(players)
```
The skills players do double the amount of pushups than the line players. 

## Inferential Results

<!--State hypothesis clearly.  Make sure your discussion of the inferential test covers all the aspects that the test output produces, such as test statistic, p-value etc.  Make a decision about the null hypothesis, explain the assumptions on which the selected test/procedure was based, and why the chosen procedure satisfys the assumptions and is appropriate to answer the research question!-->

The test we wi ll use is the t-test.
...
The null hypothesis is $H_0$ is "There is no difference between the average pushups of line vs skill players"

The boxplot shows us that the skill players are able to do a mean of about 50 pushups. Compared to the line players that are able to only do about a mean of 18 pushups. 

A t-test of differnce in means gave a p-value of 0.0000094, this is a less that 0.05, so we reject the null hypothesis and conclucde we have evidence of a difference of average pushups between players in the two positions. 